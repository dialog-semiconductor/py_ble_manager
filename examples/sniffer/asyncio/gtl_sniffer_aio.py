...
async def main(com_port_1: str, com_port_2: str, baud_rate: int, log_file: str = None):
    ...
    sniffer = ble.GtlAioSniffer(com_port_1, com_port_2, baud_rate)
    await sniffer.init()

    print("Capturing...")

    while True:
        msg = await sniffer.get_gtl_msg_str()
        if msg:
            logger.info(msg)
...
if __name__ == "__main__":
    ...
    try:
        asyncio.run(main(args.com_port_1, args.com_port_2, args.baud_rate, args.log_file))
