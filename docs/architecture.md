...
The `BleManagerGap` class processes GAP related commands and events. The `BleManagerGattc` class processes GATT client related commands and events. The `BleManagerGatts` class implementes GATT service related commands and events. The `BleManagerCommon` class implements common functionality (e.g. stack reset handling).
