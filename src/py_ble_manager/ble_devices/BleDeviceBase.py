...
class BleDeviceBase():
    ...
    def __init__(self,
        ...
        self._ble_adapter = BleAdapter(adapter_command_q, adapter_event_q, serial_tx_q, serial_rx_q)
    ...
    def address_get(self) -> Tuple[OwnAddress, BLE_ERROR]:
        ...
        .. note:
            ...
            the next air operation is started). The application will receive a
            :py:class:`~py_ble_manager.ble_api.BleGap.BleEventGapAirOpBdAddr`
            event when the private random address has been generated. Subsequent calls to
            :py:meth:`~py_ble_manager.ble_devices.BleDeviceBase.address_get()`
            will return a valid own address.

        :return: BD address, result code
        :rtype: Tuple[OwnAddress, BLE_ERROR]
        """

        return self._ble_gap.address_get()
    ...
    def address_set(self, address: OwnAddress, renew_dur: int) -> BLE_ERROR:
        ...
        :py:class:`~py_ble_manager.ble_api.BleCommon.OWN_ADDR_TYPE.PRIVATE_STATIC_ADDRESS`
