...
class TestGapcBondReqInd(unittest.TestCase):
    ...
    def generate_test_message_legacy(self):
    ...
    def generate_test_message_secure_connections(self):
        test_message = GapcBondReqInd()
        test_message.parameters.request = GAPC_BOND.GAPC_PAIRING_REQ
    ...
    def test_parameters_updated_after_construction_legacy(self):
        test_message = self.generate_test_message_legacy()
    ...
    def test_parameters_updated_after_construction_secure(self):
        test_message = self.generate_test_message_secure_connections()
    ...
    def test_factory_legacy(self):
        test_message = self.generate_test_message_legacy()
        
        # Test factory generates message appropriately 
        byte_string = bytes.fromhex(self.expected_legacy)
        factory_message = GtlMessageFactory.create_message(byte_string)
        # verify message class match
        self.assertEqual(factory_message, test_message, f"{type(factory_message).__name__}() incorrect msg created")

    def test_factory_legacy_secure_connections(self):
        test_message = self.generate_test_message_secure_connections()
        
        # Test factory generates message appropriately 
        byte_string = bytes.fromhex(self.expected_secure_connections)
        factory_message = GtlMessageFactory.create_message(byte_string)
        # verify message class match
        self.assertEqual(factory_message, test_message, f"{type(factory_message).__name__}() incorrect msg created")
...
class TestGapcParamUpdateReqInd(unittest.TestCase):
    ...
    def generate_test_message(self):
        ...
        test_message.parameters.intv_min = 39 
